...
#     '''
#     Wraps a DataIterator to provide data in a different format.

#     To use, subclass and implement _convert() and _make_input_nodes().
#     '''
...
#         '''
#         assert_is_instance(iterator, DataIterator)

#         self._iterator = iterator

#     def next_is_new_epoch(self):
#         return self._iterator.next_is_new_epoch()

#     def _next(self):
#         return self._convert(self._iterator._next())

#     def _convert(batches):
#         '''
#         Takes a batch returned from self._iterator, and converts it
#         to this ConvertingIterator's output format.

#         Parameters
#         ----------
#         batches: instance of a collections.namedtuple type.
#           The return value of self._iterator._next()
#         '''
